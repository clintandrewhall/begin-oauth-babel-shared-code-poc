  ...
  !function (f) {
    ...
    return function () {
      return function e(t, n, r) {
        ...
        for (var i = "function" == typeof commonjsRequire && commonjsRequire, o = 0; o < r.length; o++) s(r[o]);
        ...
        module.exports = function (options, callback) {
          ...
          return opts.headers = options.headers || {}, opts.headers["User-Agent"] = opts.headers["User-Agent"] || "tiny-http", opts.headers["Content-Type"] = opts.headers["Content-Type"] || "application/json", method(opts, function (res) {
            ...
            res.on("data", function (chunk) {
              ...
              res.statusCode >= 200 && res.statusCode < 300 || ((err = Error("GET failed with: " + res.statusCode)).raw = res, err.body = result.toString(), err.statusCode = res.statusCode), callback(err, {
                body: result,
                headers: res.headers
              });
            });
          ...
          var req = method(opts, function (res) {
            ...
            res.on("data", function (chunk) {
              ...
              ok ? callback(err, {
                body: result,
                headers: res.headers
              }) : ((err = Error(httpMethod + " failed with: " + res.statusCode)).raw = res, err.body = result, err.statusCode = res.statusCode, callback(err));
            });
          });
